                      ...
                      <!--  <div class="check-div form-inline">
                            <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addSource">添加图书</button>
												...
												<div class="check-div form-inline">
														...
														<button class="btn btn-white btn-xs "><a href="index.jsp">信息</a></button>
												</div>
                        <!--<div class="data-div">
	...
	<tr>
		...
		<a href="deleteProduct?id=${p.id}">删除</a>
            ...
            <div role="tabpanel" class="tab-pane" id="user">
                <div class="check-div form-inline">
                    <div class="col-xs-4">
                        <button class="btn btn-white btn-xs "><a href="../book_manager1/ManagerSelectServlet">查 询 用 户 </a></button>
                        <button class="btn btn-white btn-xs "><a href="../book_manager1/ManagerSelectBook">图 书 查 询</a></button>
                        <button class="btn btn-white btn-xs "><a href="../book_manager1/adduser.jsp">添 加 用 户</a></button>
                        <button class="btn btn-white btn-xs "><a href="add.jsp">添加图书</a></button>            
                    </div>
                </div>
                <div class="data-div">
                    <div class="row tableHeader">
