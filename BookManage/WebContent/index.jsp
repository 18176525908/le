    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                ...
                <div class="meun-item meun-item-active" href="#sour" aria-controls="sour" role="tab" data-toggle="tab"><img src="images/icon_source.png">图书管理</div>
            ...
            <div role="tabpanel" class="tab-pane" id="user">
                ...
                <div class="data-div">
                    <h5 align="center" id="">
                    <a href="../BookManage/ManagerSelectServlet">用户查询</a>
                    <a href="../BookManage/adduser.jsp">添加用户</a>
                    </h5>
                </div>
                <!--页码块-->
                <footer class="footer">
